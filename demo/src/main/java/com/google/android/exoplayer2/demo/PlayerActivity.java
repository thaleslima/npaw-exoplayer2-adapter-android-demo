...
public class PlayerActivity extends AppCompatActivity
  ...
  private DefaultBandwidthMeter BANDWIDTH_METER = new DefaultBandwidthMeter.Builder(null).build();
  ...
  private void setExoPlayerAdapter() {
    ...
    // Exoplayer2AdAdapter adAdapter = new Exoplayer2AdAdapter(player);

    adapter.setCustomEventLogger(trackSelector);
    adapter.setBandwidthMeter(BANDWIDTH_METER);

    youboraPlugin.setAdapter(adapter);
    // youboraPlugin.setAdsAdapter(adAdapter);
  }
